...
<div class="limit">
    <div class="login-container">
        <div class="bb-login">
            <form class="bb-form" action="{{route('factory.login')}}" method="POST">
                @csrf
                <div class="row mb-2">
                    <span class="col-md-9 bb-form-title p-b-26"> تسجيل الدخول للمصنع </span>
                    <h6><a href="{{route('login')}}">هل انت مستخدم؟</a></h6>
                </div>
                ...
                <div class="text-center p-t-115"> <span class="txt1"> ليس لديك حساب ؟ </span> <a class="txt2" href="{{route('factory.register')}}"> تسجيل </a> </div>
            </form>
        </div>
    </div>
</div>

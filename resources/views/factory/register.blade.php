    ...
    <div class="login-container">
        <div class="bb-login">
            <form class="bb-form" action="{{route('factory.register')}}" method="POST">
                @csrf
                <span class="bb-form-title p-b-26"> حساب جديد للمصنع </span>
                ...
                <div class="wrap-input100 mb-1 mt-3">
                    ...
                    <span class="bbb-input" data-placeholder="الوصف"></span>
                </div>
                @error('description')
                <span class="text-danger">{{$message}}</span>
                @enderror
                ...
                <div class=" mb-1 mt-3">
                    <select class="form-control text-left" type="text" name="cat_id" required>
                        <option value="{{NULL}}" selected disabled>الوصف</option>
                ...
                <div class="text-center p-t-115"> <span class="txt1"> لديك حساب بالفعل ؟ </span> <a class="txt2" href="{{route('factory.login')}}"> تسجيل دخول</a> </div>
            </form>
        </div>
    </div>
</div>

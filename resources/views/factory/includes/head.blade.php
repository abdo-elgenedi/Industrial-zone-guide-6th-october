...
<head>
    ...
    <!-- END VENDOR CSS-->
    <!-- BEGIN MODERN CSS-->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/css-rtl/app.c')}}ss">
    ...
    <link rel="stylesheet" href="{{asset("assets/admin/vendors/css/editors/summernote.css")}}">

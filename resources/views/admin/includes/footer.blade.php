...
<script src="{{asset('assets/admin/app-assets/vendors/js/pickers/spectrum/spectrum.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/admin/app-assets/vendors/js/pickers/miniColors/jquery.minicolors.min.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/admin/app-assets/js/scripts/pickers/colorpicker/picker-color.js')}}" type="text/javascript"></script>


<script src="{{asset('assets/admin/vendors/js/forms/toggle/switchery.min.j')}}s" type="text/javascript"></script>
...
<!-- END MODERN JS-->
<!-- BEGIN PAGE LEVEL JS-->
<script src="{{asset('assets/admin/js/scripts/pages/dashboard-crypt')}}o.js" type="text/javascript"></script>

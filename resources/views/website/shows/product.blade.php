                ...
                <div class="product-content product-wrap clearfix product-deatil">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-md-offset-1 col-sm-12 col-xs-12">
                            <h4 class="">
                                {{$product->name}} <br>
                                <small>المنتج بواسطة :<a href="{{route('website.show.factory',$product->factory->id)}}">{{$product->factory->name}}</a></small>
                            </h4>
                            <hr />
                            <h3 class="price-container">
                                {{$product->price}} جنية /{{$product->unit}}
                                <small>*شامل الضريبة</small>
                            </h3>
                            <hr />
                            <p class="text-{{$product->status==0?'danger':'success'}}">{{$product->status==0?'غير متوفر حاليا':'متوفر حاليا'}}</p>
                            <hr />
                            <div class="row">
                                {!! $product->description !!}
                            </div>
